                    ...
                    mokeponesEnemigos = enemigos.map(function (enemigo) {
                        ...
                        if (enemigo.mokepon && enemigo.mokepon.nombre) {
                            ...
                            if (mokeponNombre === "Hipodoge") {
                                mokeponEnemigo = new Mokepon('Hipodoge', './assets/hipodoge.png', 5, './assets/hipodoge2.png', enemigo.id)
                            } else if (mokeponNombre === "Capipepo") {
                                mokeponEnemigo = new Mokepon('Capipepo', './assets/capipepo.png', 5, './assets/capipepo2.webp', enemigo.id)
                            } else if (mokeponNombre === "Ratigueya") {
                                mokeponEnemigo = new Mokepon('Ratigueya', './assets/ratigueya.png', 5, './assets/ratigueya2.webp', enemigo.id)
                            }
                        }
